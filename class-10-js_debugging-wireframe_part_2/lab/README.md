...
* index.html
* style.css
* app.js *(if you choose to use JS; remember, you don't have to)*
...
Use good HTML structure to scaffold this site.
...
- Keep in mind that you can use *display: inline* in your CSS to force block elements, which would ordinarily stack, to sit side-by-side. Be thoughtful about your CSS layout strategy.
...
You'll be committing regularly and working on branches for additional Git practice. Submit the link to your most recent pull request into the Canvas assignment.
